            ...
            />
                    ...
                    <div className="mt-9 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        ...
                        <button
                            type="button"
                            disabled
                            aria-label="Download CV unavailable until the final document is added"
                            title="CV coming soon"
                            className="w-full cursor-not-allowed rounded-full border border-border bg-surface px-7 py-3.5 text-sm font-semibold text-muted opacity-60 sm:w-auto"
                        >
                            Download CV
                        </button>
                    </div>
